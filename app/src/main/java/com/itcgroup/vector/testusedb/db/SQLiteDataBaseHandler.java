package com.itcgroup.vector.testusedb.db;
...
public class SQLiteDataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Tu puedes implementar aqui el proceso de migracion
    ...
    public Player getPlayer(int id){
        ...
        Cursor cursor = db.query(TABLE_NAME, //a. tabla
                COLUMNS, // b. nombre de columna
                " id = ?", // c. seleccion
                new String[]{ String.valueOf(id) }, //d. valor id a obtener
                null, //e. group by
                null, // f. having
                null, // g. order by
                null); // h. limit
